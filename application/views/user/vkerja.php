                        ...
                        <div id="form-hidden">
                            <form id="basic-form" autocomplete="off" method="post" enctype="multipart/form-data" action="<?php if (isset($action)) echo $action ?>" novalidate>
                                <div class="form-group">
                                    <input type="hidden" name="id_kerja" value="<?php if (isset($getrow)) echo $getrow->id_kerja ?>">
                                    <label>Nama Perusahaan</label>
                                    <input type="text" name="nama_perusahaan" value="<?php if (isset($getrow)) echo $getrow->nama_perusahaan ?>" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Jabatan</label>
                                    <input type="text" name="jabatan" value="<?php if (isset($getrow)) echo $getrow->jabatan ?>" class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Surat Keterangan Kerja (800 Kb)</label>
                                ...
                                <a href="<?php echo base_url('riwayat/kerja') ?>" class="btn btn-primary">Batal</a>
                            </form>
                        </div>
                        <p></p>
                                ...
                                <tbody>
                                    ...
                                    if (isset($hasil)) foreach ($hasil as $val) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href='<?php echo base_url('riwayat/kerja') . '?func=updatekerja&id=' . $val->id_kerja ?>' type="button" class="btn btn-success mb-2" title="Edit"><span class="sr-only">Edit</span>
                                                    <i class="fa fa-pencil"></i></a>
                                                <a href="<?php echo base_url('riwayat/delete') . '?func=kerja&id=' . $val->id_kerja ?>" onclick="return confirm('Yakin hapus data ini ?')" type="button" class="btn btn-danger mb-2" title="Delete">
